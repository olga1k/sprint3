...
function moviesAverageOfDirector(array, director) {
 ...
 // console.log('EXERCICE 3 ->', averagePoints);
...
function moviesAverageByCategory(array, genre) {
  ...
  console.log('genres with filter', moviesGenre);
  ...
  if (moviesGenre.length >= 1) {
    averagePoints = moviesGenre.reduce((a, b) => ({
      score: a.score + b.score
    }));

    averagePoints = parseFloat(
      (averagePoints.score / moviesGenre.length).toFixed(2)
    );
